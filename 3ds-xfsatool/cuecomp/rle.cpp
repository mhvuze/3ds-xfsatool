...
/*----------------------------------------------------------------------------*/
#define BREAK(text) { printf(text); return NULL; }
#define EXIT(text)  { printf(text); exit(-1); }

/*----------------------------------------------------------------------------*/
static char *Memory(int length, int size);

unsigned char *RLE_Code(unsigned char *raw_buffer, unsigned int raw_len, unsigned int *new_len);
...
unsigned char *RLE_Decode(unsigned char *pak_buffer, unsigned int pak_len, unsigned int *output_len) {
  ...
  unsigned int   raw_len, header, len;
